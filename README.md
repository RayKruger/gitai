...
To enable the `gitai` command globally:
1. Rename `gitai_example.cmd` to `gitai.cmd`.
2. Add the project directory containing `gitai.cmd` to your System PATH.
3. The script automatically locates `gitai.py` in its own directory using relative paths.
